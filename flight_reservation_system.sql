...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2025 at 07:30 AM
...
ALTER TABLE `planes`
  ...
  ADD UNIQUE KEY `model_2` (`model`),
  ADD KEY `fk_planes_admin` (`added_by`);
...
--
ALTER TABLE `planes`
  MODIFY `plane_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `planes`
  ADD CONSTRAINT `fk_planes_admin` FOREIGN KEY (`added_by`) REFERENCES `admin` (`admin_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_planes_airline` FOREIGN KEY (`airline_id`) REFERENCES `airlines` (`airline_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `planes_ibfk_1` FOREIGN KEY (`airline_id`) REFERENCES `airlines` (`airline_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `planes_ibfk_2` FOREIGN KEY (`added_by`) REFERENCES `admin` (`admin_id`) ON DELETE CASCADE;
COMMIT;
