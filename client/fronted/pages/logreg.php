  ...
  <div class="container">
    ...
    <form id="login-form" class="form" method="POST" action="">
      ...
      <div class="form-group">
        ...
        <input id="login-username" type="text" name="username" placeholder="Enter your username" required value="<?= isset($_POST['username']) ? htmlspecialchars($_POST['username']) : '' ?>" />
      </div>
      <div class="form-group">
      ...
      <p>Don't have an account? <a href="#register" onclick="document.getElementById('login-form').style.display='none';document.getElementById('register-form').style.display='block';">Register</a></p>
    </form>
    ...
    <form id="register-form" class="form" method="POST" action="">
      ...
      <div class="form-group">
        ...
        <input id="reg-username" type="text" name="username" placeholder="Choose username" required value="<?= isset($_POST['username']) ? htmlspecialchars($_POST['username']) : '' ?>" />
      </div>
      <div class="form-group">
        <label for="reg-email">Email</label>
        <input id="reg-email" type="email" name="email" placeholder="Enter email" required value="<?= isset($_POST['email']) ? htmlspecialchars($_POST['email']) : '' ?>" />
      </div>
      <div class="form-group">
      ...
      <p>Already have an account? <a href="#login" onclick="document.getElementById('register-form').style.display='none';document.getElementById('login-form').style.display='block';">Login</a></p>
    </form>
  </div>
